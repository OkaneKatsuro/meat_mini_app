...
var ClientsService = function () {
    ...
    var ClientsService = _classThis = /** @class */ (function () {
        ...
        ClientsService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.db.client.findMany({
                            orderBy: { name: 'asc' },
                            include: {
                                shipments: {
                                    orderBy: { date: 'desc' },
        ...
        ClientsService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.db.client.findUnique({
                                where: { id: id },
                                include: {
                                    shipments: {
                                        orderBy: { date: 'desc' },
                        ...
                        case 1:
                            client = _a.sent();
                            if (!client) {
                                throw new common_1.NotFoundException("Client with ID ".concat(id, " not found"));
                            }
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.db.client.update({
                                    where: { id: id },
        ...
        ClientsService_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findOne(id)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.db.client.delete({
                                    where: { id: id },
                                })];
                    }
                });
